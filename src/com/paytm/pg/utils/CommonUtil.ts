...
export class CommonUtil {
	 ...
	 * @throws Exception
	 */
	public static getSDKResponse(e: any, obj: any) {
	 ...
	 * @throws Exception
	 */
	public static getSecureRequestHeader(clientId: string, workFlow: string, channelId: string) {
	 ...
	 * @return bool
	 */
	public static isEmptyOrNull(param: string) {
	 ...
	 * @param ...sources
	 */
	public static mergeDeep(target: any, ...sources: Array<any>): object {
	...
	* @return string
	*/
	public static getUniqueRequestId() {
